...
import useFetchUserData from "../../../hooks/userManagement/user/useFetchUsers";
import useFetchUserDelete from "../../../hooks/userManagement/user/useFetchUserDelete";
        ...
        <ComponentCard title="Users">
          <div className="relative overflow-x-auto sm:rounded-lg">
              ...
              <table className="w-full text-sm mb-4 text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {(searchValue ? userManagementData.userData.searchResults[searchValue]?.[currentPage] : userManagementData.userData.pages[currentPage])?.map((item: UserData ) => (
