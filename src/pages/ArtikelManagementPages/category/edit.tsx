...
import useFetchCategorybyId from "../../../hooks/articleManagement/category/useFetchCategorybyId";
import useFetchCategoryUpdate from "../../../hooks/articleManagement/category/useFetchCategoryUpdate";
...
export default function EditCategory() {
  const { id } = useParams();
  const categoryData: CategoryData | null = useFetchCategorybyId(id);
  const { register, setValue, reset, handleSubmit } = useForm<CategoryForm>({
    defaultValues:{
      name: '',
      description: ""
    },
  ...
  useFetchCategoryUpdate(formData, id);
  ...
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle="Edit" additionalPaths={[{ name: "Category", url: "/category-management" },]} />
